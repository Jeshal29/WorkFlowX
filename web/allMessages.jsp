...
List<Map<String,Object>> employerMessages = user.isAdmin() ? dao.getMessagesBySenderRole("EMPLOYER")
                                                                  : dao.getMessagesBySenderRoleByDepartment("EMPLOYER", user.getDepartment());
List<Map<String,Object>> employeeMessages = user.isAdmin() ? dao.getMessagesBySenderRole("EMPLOYEE")
                                                                  : dao.getMessagesBySenderRoleByDepartment("EMPLOYEE", user.getDepartment());

List<Map<String,Object>> censoredMessages = user.isAdmin()
        ? (yearParam != null && monthParam != null ? dao.getCensoredMessagesByMonth(selectedYear, selectedMonth)
                                                   : dao.getCensoredMessages())
        : dao.getCensoredMessagesByDepartment(user.getDepartment());

List<Map<String,Object>> topViolators = user.isAdmin() ? dao.getTopViolators()
                                                              : dao.getTopViolatorsByDepartment(user.getDepartment());
