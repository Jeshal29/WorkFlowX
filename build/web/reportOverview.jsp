...
<%
    ...
    if (user.isAdmin()) {
        ...
        overallStats = dao.getOverallStatsByDepartment(user.getDepartment(), user.getUserId());
        taskStats = dao.getTaskStatsByStatusAndEmployer(user.getUserId());
        leaveStats = dao.getLeaveStatsByStatusAndDepartment(user.getDepartment());
        deptStats = dao.getDepartmentStats();
        messageStats = dao.getMessageStatsByDepartment(user.getDepartment());
    }
%>
<!DOCTYPE html>
<html>
