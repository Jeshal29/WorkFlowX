...
<head>
    ...
    <title>Employee Dashboard - WorkFlowX</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    /* DARK MODE FULL OVERRIDE */
       .dark-mode {
        ...
        .card-files { border-top: 4px solid #4facfe; }
        .card-leaves { border-top: 4px solid #43e97b; }
        .card-notes { border-top: 4px solid #fa709a; }
...
<body class="<%= theme.equals("DARK") ? "dark-mode" : "" %>">
    ...
    <div class="navbar">
        <h1>WorkFlowX - Employee Portal</h1>
        <div class="user-info">
...
<% } %>
    ...
    <div class="container">
        <div class="welcome">
            ...
            <p>Manage your tasks, messages, files, and more from here.</p>
        </div>
        ...
        <div class="dashboard-grid">
            ...
            <a href="tasks.jsp" class="card card-tasks">
                <div class="card-icon">✓</div>
                <h3>My Tasks</h3>
            ...
            <a href="leaves.jsp" class="card card-leaves">
                <div class="card-icon">🏖️</div>
                <h3>Leave</h3>
                <p>Apply for leave</p>
            </a>
            
            <a href="notes.jsp" class="card card-notes">
                <div class="card-icon">📝</div>
                <h3>Notes</h3>
                <p>Personal notes</p>
            </a>
